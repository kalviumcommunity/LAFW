    ...
    return (
        <div className="bg-slate-50 min-h-[calc(100vh-80px)] px-4 py-12 flex items-center justify-center">
            <div className="bg-white p-8 rounded-lg shadow-sm w-full max-w-3xl">
                <h2 className="text-3xl font-bold mb-8 text-center text-slate-800 border-b border-slate-200 pb-4">Report a Found Item</h2>

                <form onSubmit={handleSubmit} noValidate>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                        <div className="md:col-span-2">
                            <label htmlFor="name" className="form-label">Item Name</label>
                            <input type="text" id="name" className="form-input" required placeholder="E.g., Blue Backpack, Silver Ring" />
                        </div>
                        <div>
                             <label htmlFor="dateFound" className="form-label">Date Found</label>
                            <input type="date" id="dateFound" className="form-input" required />
                        </div>
                         <div>
                             <label htmlFor="locationFound" className="form-label">Location Found</label>
                            <input type="text" id="locationFound" placeholder="E.g., Library 2nd Floor" className="form-input" required />
                        </div>
                         <div>
                             <label htmlFor="contactNo" className="form-label">Your Contact Number</label>
                            <input type="tel" id="contactNo" placeholder="For the owner to reach you" className="form-input" required />
                        </div>
                        <div>
                        ...
                        <div className="md:col-span-2">
                            ...
                            <textarea id="description" placeholder="Describe the item, its condition, and any distinguishing features..." className="form-input min-h-[100px]" required ></textarea>
                        </div>
                    </div>
